classdef cellLabeler < handle
    ...
    methods
        function obj = cellLabeler(folderPath, channel, imIndex)
            ...
            % scj 20250708
%             [~, fnlist, ~] = listfiles(folderPath, '.tif');
%             disp("fnlist:"); disp(fnlist)
%             obj.imArray = fullfile(folderPath, fnlist);
%             disp("obj.imArray:"); disp(obj.imArray)
            ...
            % 让控制窗口也能响应键盘快捷键
            obj.fig_controls.KeyPressFcn = @obj.parseKey;
            ...
            obj.fig_lumSlid = uifigure('Resize', 'off',...
                ...
                'CloseRequestFcn',@obj.closeFunction);
            % 让亮度窗口也能响应键盘快捷键
            obj.fig_lumSlid.KeyPressFcn = @obj.parseKey;
